...
public class InterdimensionalAddressBook extends BlockWithEntity {
    public InterdimensionalAddressBook(Settings settings) {
        super(settings);
    }
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new InterdimensionalAddressBookBlockEntity(pos, state);
    }
